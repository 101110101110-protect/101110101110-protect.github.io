    ...
    const rerenderItems = () => {
      ...
      for (const dataRow of data) {
        ...
        for (const column of columns) {
          ...
          divWrapper.addEventListener('click', e => {
            if (activeWrapper) {
              divWrapper.innerHTML = ''; // divWrapper.classList.remove('wrapper_withoutinput')
              // divWrapper.appendChild(x)
              ...
              label.appendChild(checkmark); //<div  data-id="' + dataRow.id + '">
          ...
          let checked = dataRow.state.checked ? 'checked' : '';
          divWrapper.innerHTML = ''; //  divWrapper.classList.add('wrapper_withoutinput')
