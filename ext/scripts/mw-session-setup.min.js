...
/* harmony import */ var _syncSessionsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony import */ var _archiveSessionsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
/* harmony import */ var _assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21);
/* harmony import */ var _assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  initDefaultData() {
    ...
    this._VIEW_privateSessions = {
      ...
      tableItemComponent: _privateSessionsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__.default,
    ...
    this._VIEW_syncSessions = {
      ...
      tableItemComponent: _syncSessionsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_1__.default,
    ...
    this._VIEW_archiveSessions = {
      ...
      tableItemComponent: _archiveSessionsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_2__.default,
  ...
  initSyncSessions() {
    ...
    this.initSearch(rootProps);
    this.initSort(rootProps);
    this.initRootCheckbox(rootProps); // this.initFooterButtons( rootProps )
  }
  ...
  getRowHandlers(props, tableName, id) {
    // timestamp -- uniq ID
    ...
    const delHandler = () => {
      props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_4__.default)(props.store, 'created', id);
  ...
  initSort(props) {
    ...
    props.view.sortBtn.addEventListener('click', e => {
      ...
      if (!sortState.isActive && !sortState.isReverse) {
        ...
        let sortedData = (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__.default)(props.store, 'name', sortState.isReverse);
        this.renderData(props);
        return;
      }
  ...
  sortData(data, sortState) {
    ...
    if (sortState.isActive && !sortState.isReverse) {
      return (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__.default)(data, 'name', sortState.isReverse);
    }
  ...
  initFooterButtons(props) {
    ...
    props.view.footer.delete.addEventListener('click', () => {
      props.state.checkedIDs.map(item => {
        props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_4__.default)(props.store, 'created', item);
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_dateProvider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
/* harmony import */ var _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  createComponent() {
    ...
    configWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.os).getIcon());
    configWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.browser).getIcon());
    let proxyWrapper = document.createElement('div');
    proxyWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.proxy.flag).getIcon());
    ...
    let dateCreated = document.createTextNode(new _assets_dateProvider_js__WEBPACK_IMPORTED_MODULE_0__.default(this.dataString.created).getFullTime());
    dateCreatedWrapper.appendChild(dateCreated);
    let lastUsedWrapper = document.createElement('div');
    let lastUsed = document.createTextNode(new _assets_dateProvider_js__WEBPACK_IMPORTED_MODULE_0__.default(this.dataString.lastUsed).getFullTime());
    ...
    delWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default('trash').getIcon());
    editWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default('edit').getIcon());
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  createComponent() {
    ...
    checkboxWrapper.appendChild(checkbox);
    trimmedWrapper.appendChild(document.createTextNode(this.dataString.name));
    checkboxWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.os).getIcon());
    checkboxWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.browser).getIcon());
    checkboxWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.flag).getIcon());
    checkboxWrapper.appendChild(trimmedWrapper);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  createComponent() {
    ...
    lastUsedWrapper.appendChild(lastUsed);
    let commentWrapper = document.createElement('div');
    commentWrapper.appendChild(document.createTextNode(new _assets_dateProvider_js__WEBPACK_IMPORTED_MODULE_0__.default(this.dataString.archiveDate).getFullTime()));
    checkbox.addEventListener('change', e => {
      this.handlers.checkbox(e.target.checked);
    });
    wrapper.appendChild(checkboxWrapper);
...
/* harmony export */   "default": function() { return /* binding */ sortArrayByField; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ delArrayItemByFieldAndValue; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _groupsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/* harmony import */ var _sessionSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);
/* harmony import */ var _assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
/* harmony import */ var _assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  initDefaultData() {
    ...
    this._VIEW_groups = {
      table: mwPrivate.querySelectorAll('.static_table .tbody')[0],
      tableItemComponent: _groupsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__.default,
      mainCheckbox: mwPrivate.querySelectorAll('.thead input[type=checkbox]')[0],
      search: mwPrivate.querySelectorAll('.search input')[0],
      sortBtn: mwPrivate.querySelectorAll('.thead .triangle')[0],
      footer: {
    ...
    this._VIEW_syncSessions = {
      table: mwSync.querySelectorAll('.static_table .tbody')[0],
      tableItemComponent: _sessionSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_1__.default,
      mainCheckbox: mwSync.querySelectorAll('.thead input[type=checkbox]')[0],
      search: mwSync.querySelectorAll('.search input')[0],
      sortBtn: mwSync.querySelectorAll('.thead .triangle')[0],
      footer: {
  ...
  getRowHandlers(props, tableName, id) {
    ...
    const delHandler = () => {
      props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_3__.default)(props.store, 'created', id);
      this.renderData(props);
    };
  ...
  initSort(props) {
    ...
    props.view.sortBtn.addEventListener('click', e => {
      ...
      if (!sortState.isActive && !sortState.isReverse) {
        ...
        e.target.classList.add('active');
        e.target.classList.add('down');
        let sortedData = (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_2__.default)(props.store, 'name', sortState.isReverse);
        this.renderData(props);
        return;
      }
  ...
  sortData(data, sortState) {
    ...
    if (sortState.isActive && !sortState.isReverse) {
      return (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_2__.default)(data, 'name', sortState.isReverse);
    }
  ...
  initFooterButtons(props) {
    ...
    props.view.footer.delete.addEventListener('click', () => {
      props.state.checkedIDs.map(item => {
        props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_3__.default)(props.store, 'created', item);
      });
      props.state.checkedIDs = [];
      that.renderData(props);
    });
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  createComponent() {
    ...
    members.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default('members').getIcon());
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bookmarksSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
/* harmony import */ var _assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var _assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  initDefaultData() {
    ...
    this._VIEW_bookmarks = {
      table: mwPrivate.querySelectorAll('.static_table .tbody')[0],
      tableItemComponent: _bookmarksSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__.default,
      mainCheckbox: mwPrivate.querySelectorAll('.thead input[type=checkbox]')[0],
      search: mwPrivate.querySelectorAll('.search input')[0],
      sortBtn: mwPrivate.querySelectorAll('.thead .triangle')[0],
      footer: {
  ...
  getRowHandlers(props, tableName, id) {
    ...
    const delHandler = () => {
      props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_2__.default)(props.store, 'created', id);
      this.renderData(props);
    };
  ...
  initSort(props) {
    ...
    props.view.sortBtn.addEventListener('click', e => {
      ...
      if (!sortState.isActive && !sortState.isReverse) {
        ...
        e.target.classList.add('active');
        e.target.classList.add('down');
        let sortedData = (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_1__.default)(props.store, 'name', sortState.isReverse);
        this.renderData(props);
        return;
      }
  ...
  sortData(data, sortState) {
    ...
    if (sortState.isActive && !sortState.isReverse) {
      return (0,_assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_1__.default)(data, 'name', sortState.isReverse);
    }
  ...
  initFooterButtons(props) {
    ...
    props.view.footer.delete.addEventListener('click', () => {
      props.state.checkedIDs.map(item => {
        props.store = (0,_assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_2__.default)(props.store, 'created', item);
      });
      props.state.checkedIDs = [];
      that.renderData(props);
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _timemachineSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
/* harmony import */ var _assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var _assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  initDefaultData() {
    ...
    this._VIEW_timemachine = {
      table: mwPrivate.querySelectorAll('.static_table .tbody')[0],
      tableItemComponent: _timemachineSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__.default,
      mainCheckbox: mwPrivate.querySelectorAll('.thead input[type=checkbox]')[0],
      search: mwPrivate.querySelectorAll('.search input')[0],
      sortBtn: mwPrivate.querySelectorAll('.thead .triangle')[0],
      footer: {
  ...
  inittimemachine() {
    ...
    this.renderData(rootProps);
    this.initSearch(rootProps); //this.initFooterButtons( rootProps )
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _downloadsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31);
/* harmony import */ var _assets_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var _assets_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  initDefaultData() {
    ...
    this._VIEW_downloads = {
      table: mwPrivate.querySelectorAll('.static_table .tbody')[0],
      tableItemComponent: _downloadsSingleDataViewComponent_js__WEBPACK_IMPORTED_MODULE_0__.default,
      mainCheckbox: mwPrivate.querySelectorAll('.thead input[type=checkbox]')[0],
      search: mwPrivate.querySelectorAll('.search input')[0],
      sortBtn: mwPrivate.querySelectorAll('.thead .triangle')[0],
      footer: {
  ...
  initdownloads() {
    ...
    this.renderData(rootProps);
    this.initSearch(rootProps); //this.initSort( rootProps )
    //this.initRootCheckbox( rootProps )
    //this.initFooterButtons( rootProps )
  }
...
/* harmony default export */ __webpack_exports__["default"] = (class {
  ...
  createComponent() {
    ...
    imageWrapper.appendChild(new _assets_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(fileType).getIcon());
...
/* harmony import */ var _modules_assets_tableHandler_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
...
/* harmony import */ var _modules_sync_groups_groupsManagerHandler_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(23);
/* harmony import */ var _modules_bookmarks_bookmarksManagerHandler_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(26);
/* harmony import */ var _modules_timemachine_timemachineManagerHandler_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(28);
/* harmony import */ var _modules_downloads_downloadsManagerHandler_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(30);
...
new _modules_assets_tableHandler_js__WEBPACK_IMPORTED_MODULE_6__.default();
...
new _modules_sync_groups_groupsManagerHandler_js__WEBPACK_IMPORTED_MODULE_14__.default();
new _modules_bookmarks_bookmarksManagerHandler_js__WEBPACK_IMPORTED_MODULE_15__.default();
new _modules_timemachine_timemachineManagerHandler_js__WEBPACK_IMPORTED_MODULE_16__.default();
new _modules_downloads_downloadsManagerHandler_js__WEBPACK_IMPORTED_MODULE_17__.default();
