...
/* harmony import */ var _dist_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21);
/* harmony import */ var _dist_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {
  ...
  getRowHandlers(props, tableName, id) {
    ...
    const delHandler = () => {
      props.store = (0,_dist_delArrayItemByFieldAndValue_js__WEBPACK_IMPORTED_MODULE_4__.default)(props.store, 'created', id);
  ...
  initSort(props) {
    ...
    props.view.sortBtn.addEventListener('click', e => {
      ...
      if (!sortState.isActive && !sortState.isReverse) {
        ...
        let sortedData = (0,_dist_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__.default)(props.store, 'name', sortState.isReverse);
        this.renderData(props);
        return;
      }
  ...
  sortData(data, sortState) {
    ...
    if (sortState.isActive && !sortState.isReverse) {
      return (0,_dist_sortArrayByField_js__WEBPACK_IMPORTED_MODULE_3__.default)(data, 'name', sortState.isReverse);
    }
  ...
  initFooterButtons(props) {// props.view.footer.delete.addEventListener('click', () => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {
  ...
  createComponent() {
    ...
    checkboxWrapper.appendChild(checkbox);
    trimmedWrapper.appendChild(document.createTextNode(this.dataString.name));
    checkboxWrapper.appendChild(new _dist_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.os).getIcon());
    checkboxWrapper.appendChild(new _dist_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.browser).getIcon());
    checkboxWrapper.appendChild(new _dist_iconProvider_js__WEBPACK_IMPORTED_MODULE_1__.default(this.dataString.config.flag).getIcon());
    checkboxWrapper.appendChild(trimmedWrapper);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {
  ...
  createComponent() {
    ...
    lastUsedWrapper.appendChild(lastUsed);
    let commentWrapper = document.createElement('div');
    commentWrapper.appendChild(document.createTextNode(new _dist_dateProvider_js__WEBPACK_IMPORTED_MODULE_0__.default(this.dataString.archiveDate).getFullTime()));
    checkbox.addEventListener('change', e => {
      this.handlers.checkbox(e.target.checked);
    });
    wrapper.appendChild(checkboxWrapper);
