      ...
      for (const proxyRow of data) {
        ...
        for (const column of columns) {
          if (colCounter === 0) {
            ...
            if (colCounter === 2 ) {
                divWrapper.style.backgroundImage = "url(./assets/images/mw/" + proxyRow.state.connectionIpFlag + ".svg)"
            }
            if ( colCounter === 3) {
                divWrapper.style.backgroundImage = "url(./assets/images/mw/"  + proxyRow.state.proxyIpFlag + ".svg)"
            }
