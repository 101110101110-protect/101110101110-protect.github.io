      ...
      for (const agentRow of data) {
        ...
        for (const column of columns) {
          if (colCounter === 0) {
            ...
            let osImg = '<img src="./assets/images/userAgents/' + agentRow.config.os + '.png" style="margin-top: 12px;margin-left: 16px;margin-right: 12px;"/>';
            let browserImg = '<img src="./assets/images/userAgents/' + agentRow.config.browser + '.png"/>';
