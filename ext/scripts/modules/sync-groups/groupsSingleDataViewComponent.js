...
export default class {
  ...
  createComponent() {
    ...
    let membersHTML = document.createTextNode(this.dataString.members.join(', '));

    let members = document.createElement('span')
    let membersCount = document.createTextNode(this.dataString.members.length)

    members.appendChild(new IconProvider('members').getIcon())
        members.appendChild(membersCount)
      membersWrapper.appendChild( members)
